...
(defn merge-sort [the-list] (if (> (count the-list) 1) (let [[list1 list2] (split-at (quot (count the-list) 2) the-list)] (merge-step (merge-sort list1) (merge-sort list2))) the-list))
